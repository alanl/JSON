...
class ISSView: UIView {
  ...
  let longitudeKey = Library.label(text: "Longitude", multiplier: 1.1, textColor: .clear)
  let longitudeValue = Library.label(text: "", multiplier: 1.1, textColor: .white)
  let altitudeKey = Library.label(text: "Altitude", multiplier: 1.1, textColor: .clear)
  let altitudeValue = Library.label(text: "", multiplier: 1.1, textColor: .white)
  let velocityKey = Library.label(text: "Velocity", multiplier: 1.1, textColor: .clear)
  let velocityValue = Library.label(text: "", multiplier: 1.1, textColor: .white)
  let visibilityKey = Library.label(text: "Visibility", multiplier: 1.1, textColor: .clear)
  let visibilityValue = Library.label(text: "", multiplier: 1.1, textColor: .white)
  ...
  func initialize() {
    ...
    NSLayoutConstraint.activate([
      ...
      latitudeKey.topAnchor.constraint(equalTo: layoutGuide.topAnchor, constant: Library.marginLarge)])
